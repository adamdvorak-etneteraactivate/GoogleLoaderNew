...
def run_full_load_pipeline(sql_id, sql_pwd, sql_server, sql_db, sql_schema, sql_table, gcs_bucket_name, bq_table_id_short, max_rows=None, replace_table=1, credentials=None, gcs_client=None, bq_client=None):
    ...
    try:
        ...
        # Znovu získáváme čisté názvy sloupců (index 0 v popisu)
    ...
    try:
        ...
        # Zde už nemáme chybu [Errno 2], protože používáme blob.open("w")
        ...
        # Odstraněna nefunkční metadata a upload_from_filename.
        logging.info(f"Data uložena do GCS: gs://{gcs_bucket_name}/{temp_blob_name}.")
    ...
    try:
        ...
        # Opravený typo (používá temp_blob_name)
